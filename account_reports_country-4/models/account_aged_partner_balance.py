    ...
    def _get_sql(self):
        ...
        query = ("""
            SELECT
                ...
                account_move_line.partner_id AS partner_id,country.id AS country_id,
                partner.name AS partner_name, country.name AS country_name,
            ...
            GROUP BY account_move_line.id, partner.id,country.id, trust_property.id, journal.id, move.id, account.id,
